...
public class ConstUtils {
     ...
     * 1-9 + 0-9 六位地址码
     * 1-9 + 0-9 四位年份
     * 第一位为0第二位为0-9任意 或者 第一位为1第二位为0-2 两位月份
     * 第一位0或1或2 第二位0-9 或者 第一位3 第二位0-1 两位日期
     * 3为0-9加0-9Xx中的一个 最后 四位
     */
     ...
     * 正则：人民币
     */
    public static final String REGEX_RMB = "[0-9]+(\\.[0-9]{0,1})?";

    /**
     * 4位验证码
     */
    public static final String REGEX_CERIFY_CODE = "[0-9]{4}";
}